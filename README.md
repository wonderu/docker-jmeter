[![Docker Build](https://github.com/xtotut/docker-jmeter/actions/workflows/docker.yml/badge.svg)](https://github.com/xtotut/docker-jmeter/actions/workflows/docker.yml)
[![Patreon](https://img.shields.io/badge/patreon-donate-yellow.svg)](https://patreon.com/xtotut)
...
Find Images of this repo on [Docker Hub](https://hub.docker.com/r/xtotut/jmeter).
...
of the pre-built Images from [Docker Hub](https://hub.docker.com/r/xtotut/jmeter).
...
1. In a Terminal/Command session, install Git, navigate/make a folder, then:
   ...
   ```
   git clone https://github.com/xtotut/docker-jmeter.git
   cd docker-jmeter
   ```
...
1. Run the Build script to download dependencies, including the docker CLI:
   ...
   <tt>Successfully tagged xtotut/jmeter:5.6.2</tt>
